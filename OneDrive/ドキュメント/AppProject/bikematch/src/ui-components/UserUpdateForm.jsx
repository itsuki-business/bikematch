...
export default function UserUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setBike_maker(cleanValues.bike_maker);
    setBike_model(cleanValues.bike_model);
    setShooting_genres(cleanValues.shooting_genres ?? []);
    setCurrentShooting_genresValue("");
    setPrice_range_min(cleanValues.price_range_min);
    setPrice_range_max(cleanValues.price_range_max);
    setEquipment(cleanValues.equipment);
    setBio(cleanValues.bio);
    setProfile_image(cleanValues.profile_image);
    setPortfolio_website(cleanValues.portfolio_website);
    setInstagram_url(cleanValues.instagram_url);
    setTwitter_url(cleanValues.twitter_url);
    setYoutube_url(cleanValues.youtube_url);
    setSpecial_conditions(cleanValues.special_conditions ?? []);
    setCurrentSpecial_conditionsValue("");
    setIs_accepting_requests(cleanValues.is_accepting_requests);
    setAverage_rating(cleanValues.average_rating);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          bike_maker: bike_maker ?? null,
          bike_model: bike_model ?? null,
          shooting_genres: shooting_genres ?? null,
          ...
          is_accepting_requests: is_accepting_requests ?? null,
